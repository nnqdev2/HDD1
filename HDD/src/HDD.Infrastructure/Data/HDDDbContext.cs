...
namespace HDD.Infrastructure.Data
{
    public partial class HDDDbContext : ApplicationDbContext
    {
        ...
        //public virtual DbSet<VinsByOwner> VinsByOwner { get; set; } = null!;
        public virtual DbSet<ApGetVinsByOwnerId> ApGetVinsByOwnerId { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ApGetVinsByOwnerId>().HasNoKey();
